...
### Project 01 - Rock vs Mine Prediction
...
### Project 05 - House Price Prediction System
...
| ----------------- | --------: | --------: | -------: |
| XGBoost           | 47,612.81 | 31,606.35 |    0.827 |
| Random Forest     | 48,941.70 | 31,628.40 |    0.817 |
| Linear Regression | 70,059.19 | 50,670.49 |    0.625 |
...
### Project 24 - Fake News Detection using LSTM and Word Embeddings
...
* Learn Deep Learning, NLP, and MLOps through practical implementation.
* Develop end-to-end Machine Learning solutions.
* Create a strong GitHub portfolio for internships and full-time opportunities.
